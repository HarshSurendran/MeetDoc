...
export class ChatRepository extends BaseRepository<MessageDocument> implements IChatRepository {
    ...
    async searchMessages(userObjectId: Types.ObjectId, otherUserObjectId: Types.ObjectId): Promise<MessageDocument[]> {
    ...
    async markAsRead(userObjectId,senderObjectId) : Promise<{
    ...
    async getLatestMessage(senderObjectId: Types.ObjectId, receiverObjectId: Types.ObjectId, content: string) : Promise<MessageDocument> {
        return await this.MessageModel
            .findOne({
