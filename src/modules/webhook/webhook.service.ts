    ...
    switch (event.type) {
      ...
      case 'payment_intent.succeeded':
        ...
        if (paymentIntent.metadata.type === 'Subscription') {
          console.log(
            'reached subscription payment success',
        ...
        const updateSlot = await this.SlotsRepo.updateSlot(
          paymentIntent.metadata.slotId,
          { status: SlotStatus.Booked, pendingBookingExpiry: null },
        );
        const booking = {
        ...
        console.log(
          'This is the notification from payment success',
          notification,
        );
        ...
        console.log(
          'Payment completed. Data saved to the database..',
          createBooking,
        );
        break;
